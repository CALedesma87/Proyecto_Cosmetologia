...
public class MainPrincipal extends javax.swing.JFrame {
    ...
    public MainPrincipal() {
        ...
        Timer tiempo = new Timer(1000, (ActionEvent e) -> {
            actualizarDateTime();
        });
        tiempo.start();
        ...
        vista = (CardLayout) JpVistaPrincipal.getLayout();

    }

    private void actualizarDateTime() {
        ...
        // Establecer la cadena formateada en jlFechaHora
        jlFechaHora.setText(formattedDateTime);
    }
    ...
    private void initComponents() {
        ...
        JpVistaPrincipal = new javax.swing.JPanel();
        ...
        jLabel1.setText("LR COSMETOLOGIA");
        ...
        jlFechaHora.setForeground(new java.awt.Color(102, 0, 102));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(jPanel9, javax.swing.GroupLayout.DEFAULT_SIZE, 115, Short.MAX_VALUE))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(jlFechaHora, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(23, 23, 23))
        );

        jpPrincipal.add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 190, 500));

        JpVistaPrincipal.setBackground(new java.awt.Color(232, 227, 232));
        JpVistaPrincipal.setLayout(new java.awt.CardLayout());
        jpPrincipal.add(JpVistaPrincipal, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 0, 610, 500));
    ...
    private void jLabel2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel2MouseClicked
        JpVistaPrincipal.add(clienteView, "alta");
        vista.show(JpVistaPrincipal, "alta");
    ...
    private javax.swing.JPanel JpVistaPrincipal;
